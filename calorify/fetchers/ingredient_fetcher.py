...
def get_ingredients_for_local_image(file_path):
    """
    Given a local file path to an image, fetches ingredients with Clarifai and returns them. 
    """
...
def get_ingredients_for_url(url):
    """
    Given a URL to an image, fetches ingredients with Clarifai and returns them.
    """
